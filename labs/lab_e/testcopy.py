...
colorThresholds = (BLUE, GREEN, ORANGE, RED, YELLOW, PURPLE)
...
def update_contour():
    ...
    if image is None:
        ...
        # TODO Part 2: Search for line colors, and update the global variables # contour_center and contour_area with the largest contour found
...
# If there is a big enough contour
            ...
            # Assigns area and center of largest contour 
                ...
                if contour_center != None:
                    ...
                    cv.drawContours(image, [max_contour], 0, (255, 0, 255), 3) 
                    cv.circle(image, (contour_center[1], contour_center[0]), 3, (255, 0, 255), -1)
        ...
        # then select the correct color of traffic light detected.
            ...
            BGR_color = (0,0,0)    # Fills image with contour center color
