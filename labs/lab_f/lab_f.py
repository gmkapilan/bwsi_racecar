...
WHITE = ((102, 50, 150),(110, 70, 210))
PURPLE = ((130, 50, 50),(140, 255, 255))
YELLOW = ((25, 50, 50),(36, 255, 255))
PINK = ((128, 200, 150), (145, 220, 225))
BLACK = ((0,0,0), (0,0,0))
#Color priority: Red >> Green >> Blue
COLOR_PRIORITY = (RED, GREEN, BLUE)
#BLUE, GREEN, RED goes to purple cone
#RED, GREEN, BLUE goes to yellow cone
#GREEN, BLUE, RED doesn't work?
#RED, BLUE, GREEN goes to yellow cone
#BLUE, RED, GREEN goes to purple cone
#GREEN, RED, BLUE goes to black cone
colors = {
    BLUE : "blue",
    GREEN : "green",
    RED : "red",
...
def update_contour():
    ...
    if image is None:
        ...
        if maxContour is not None:
            ...
            contour_center = rc_utils.get_contour_center(maxContour)
            contour_area = rc_utils.get_contour_area(maxContour)
        ...
        coneContours = ()
        for coneColor in coneColors:
            coneContours += rc_utils.find_contours(image, coneColor[0], coneColor[1])
        ...
        if maxConeContour is not None:
            ...
            rc_utils.draw_contour(image, maxConeContour)
        else:
            cone_area = 0
...
def update():
    ...
    if rc.controller.was_pressed(rc.controller.Button.X):
        ...
        print("The color priority has changed!")
